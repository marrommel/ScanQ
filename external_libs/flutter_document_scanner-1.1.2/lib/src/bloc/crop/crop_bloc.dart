...
class CropBloc extends Bloc<CropEvent, CropState> {
  ...
  Future<void> _areaInitialized(
    ...
    area = area.copyWith(
      topRight: Point(
        min(max(area.topRight.x, 0), _imageRect.width),
        min(max(area.topRight.y, 0), _imageRect.height),
      ),
      topLeft: Point(
        min(max(area.topLeft.x, 0), _imageRect.width),
        min(max(area.topLeft.y, 0), _imageRect.height),
      ),
      bottomLeft: Point(
        min(max(area.bottomLeft.x, 0), _imageRect.width),
        min(max(area.bottomLeft.y, 0), _imageRect.height),
      ),
      bottomRight: Point(
        min(max(area.bottomRight.x, 0), _imageRect.width),
        min(max(area.bottomRight.y, 0), _imageRect.height),
      ),
    );
