...
import 'package:scanq_multiplatform/activity_vocabulary_book.dart';
...
class _CategoryEntry extends State<CategoryEntry> {
  ...
  void _showContextMenu(BuildContext context) async {
    ...
    final CategoryOptions? option = await showMenu(
        ...
        items: [
          PopupMenuItem(
              value: CategoryOptions.optionEdit,
              child: Text(
                AppLocalizations.of(context)!.edit
              )
          ),
          PopupMenuItem(
              value: CategoryOptions.optionDelete,
              child: Text(
              ...
              return GestureDetector(
                  onTap: () {
                    ...
                    Navigator.of(context).push(
                        MaterialPageRoute(
                            builder: (context) => VocabularyBook(category: widget.category)
                        )
                    );
                  },
                  ...
                  child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              AppLocalizations.of(context)!.xOfXVocabsLearned(
                                  snapshot.data!.amountLearned,
                                  snapshot.data!.categoryVocabsTotal),
                              style: const TextStyle(
                                  fontSize: 14
                              )
                          )
                  ...
                  child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              AppLocalizations.of(context)!.noVocabulariesYet,
                              style: const TextStyle(
                                  fontSize: 14
                              )
                          )
